<?php
class Mdl_compound extends CI_Model
{
	...
	public function registration($master,$pseat,$aseat,$village,$policestaion,$firestation,$name,$ruleauth,$mainentrance,$otherentrance,$latitude,$longitude,$roadfacility,$distancetoroad,$road,$helipad,$nearcompound,$postalservice,$pincode,$postoffice,$ss,$dataentry,$service_name,$office,$code,$n,$o,$d,$sr)
	{
		...
		if($this->db->insert('compound',$data))
		{
					$id=$this->db->insert_id();
					$this->db->query("UPDATE compound SET unique_id=CONCAT('CMP',slno) where slno=$id;");
