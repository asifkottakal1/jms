<?php
class Cashrcpt extends CI_Controller
{
	...
	public function index()
	{
		if(isset($_SESSION['userDetails']))
		{
			...
			$this->load->view('universe/cashrcpt_reg');
...
public function verify_rcptname()
	...
	function get_agrphname($stag)
  {
	...
	public function cashrcpt_reg()
	{
		if(isset($_SESSION['userDetails']))
		{
			if(isset($_SESSION['rcptname_exist'])&&isset($_SESSION['ss_registration'])&&isset($_SESSION['agrphname_exist']))
			{
