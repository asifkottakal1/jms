<?php
class Firmreg extends CI_Controller
{
  ...
  public function index()
  {
    if(isset($_SESSION['userDetails']))
    {
      ...
      $this->load->view('user/firmreg_reg');
...
//   }
  ...
  function get_areauid($stag)
  {
    if(isset($_SESSION['userDetails'])&&$this->uri->segment(3)==true)
    {
      ...
      if($res=$this->Mdl_firmreg->get_areauid($stag))
      {
        $data=array();
        // print_r($res);
        foreach($res as $row)
 ...
 //  }
  ...
  public function firmreg_reg()
  {
    if(isset($_SESSION['userDetails']))
    {
      if(isset($_SESSION['areauid_exist'])&&isset($_SESSION['ss_registration']))
      {
        ...
        if($this->Mdl_firmreg->firmreg_reg($data))
        {
