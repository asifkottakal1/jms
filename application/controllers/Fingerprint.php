...
class Fingerprint extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('Mdl_fingerprint');
	}
	public function index()
	{
		if(isset($_SESSION['userDetails']))
		{
			...
			$this->load->view('user/fingerprint_reg');
	...
	public function fingerprint_reg()
	{
		if(isset($_SESSION['userDetails']))
		{
			if(isset($_SESSION['member_exist'])&&isset($_SESSION['ss_registration']))
			{
				...
				if($this->Mdl_fingerprint->fingerprint_reg($data))
				{
					echo "<center><h2>Successfully registered <b>".$memid."'s fingerprint</b>!</h2><br><a href='javascript:history.go(-1)'>Go back</a></center>";
					$this->clear_all();
				}
				else
				{
