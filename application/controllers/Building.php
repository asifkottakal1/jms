...
class Building extends CI_Controller
{
	...
	public function index()
	{
		if(isset($_SESSION['userDetails']))
		{
			...
			$this->load->view('universe/building_reg');
...
// print_r($_POST);
		...
		$code=$this->input->post('code');
		 ...
		 $d=$this->input->post('Department');//array
  		...
  		//$uc=$this->input->post('ucode');
  		$oc=$this->input->post('ocpn');
  		$sq=$this->input->post('sqft');
  		$fa=$this->input->post('facility');
  ...
  //      print_r($_POST);
		...
		*/
		...
		$res=$this->Mdl_building->registration($master,$pseat,$aseat,$village,$policestaion,$firestation,$name,$ruleauth,$mainentrance,$otherentrance,$latitude,$longitude,$roadfacility,$distancetoroad,$road,$helipad,$nearcompound,$postalservice,$pincode,$postoffice,$ss,$dataentry,$service_name,$office,$code,$n,$o,$d,$sr,$gf,$oc,$sq,$fa,$fl);
		if($res)
