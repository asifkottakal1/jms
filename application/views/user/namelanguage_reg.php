    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="#"><b>Name and Language Registration</b></a>
        </li>
      ...
      <form method="post" action="<?php echo base_url()?>nameLanguage/namelanguage_reg">
      ...
      <div class="row row_space">
        <div class="col-sm-3">
          <label class="label_left">Name in English Letters</label>
        </div>
        <div class="col-sm-6">
          <input type="text" name="engname" id="engname" class="form-control" required placeholder="Type Name in English Letters">
        </div>
        <div class="col-sm-3">
            <button type="button" class="verify_btn verify_engName" onclick="verify_who('engName')">Verify & Confirm</button>
        </div>
      </div>

      <div class="row row_space">
        <div class="col-sm-3">
          <label class="label_left">Mother Language</label>
        </div>
        <div class="col-sm-6">
          <select name="motherlang" id="motherlang" reuired class="form-control" onchange="change_language(this)">
      ...
      <div class="row row_space">
        <div class="col-sm-3">
          <label class="label_left">Name in Mother Language</label>
        </div>
        <div class="col-sm-6">
          <input type="text" name="motherlangname" id="motherlangname" class="form-control" required>
        </div>
        <div class="col-sm-3">
            <button type="button" class="verify_btn verify_motherlangname" onclick="verify_who('motherlangname')">Verify & Confirm</button>
        </div>
      </div>

      <div class="row row_space">
        <div class="col-sm-3">
          <label class="label_left">Name in State Language</label>
        </div>
        <div class="col-sm-6">
          <input type="text" name="statelang" id="statelang" class="form-control" required>
        </div>
        <div class="col-sm-3">
            <button type="button" class="verify_btn verify_statelang" onclick="verify_who('statelang')">Verify & Confirm</button>
        </div>
      </div>

      <div class="row row_space">
        <div class="col-sm-3">
          <label class="label_left">Name in National Language</label>
        </div>
        <div class="col-sm-6">
          <input type="text" name="nationlang" id="nationlang" class="form-control" required>
        </div>
        <div class="col-sm-3">
            <button type="button" class="verify_btn verify_nationlang" onclick="verify_who('nationlang')">Verify & Confirm</button>
        </div>
      </div>

      <div class="row row_space">
        <div class="col-sm-3">
          <label class="label_left">More Used Other Language</label>
        </div>
        <div class="col-sm-6">
          <select name="morelang" id="morelang" reuired class="form-control" onchange="change_morelanguage(this)">
             <option value="">---Select---</option>
      ...
      <div class="row row_space">
        <div class="col-sm-3">
          <label class="label_left">Name in More Used Other Language</label>
        </div>
        <div class="col-sm-6">
          <input type="text" name="otherlang" id="otherlang" class="form-control">
        </div>
        <div class="col-sm-3">
            <button type="button" class="verify_btn verify_otherlang" onclick="verify_who('otherlang')">Verify & Confirm</button>
        </div>
      </div>
