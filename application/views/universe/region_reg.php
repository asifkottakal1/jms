    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="#"><b>Region Registration</b></a>
        </li>
        <li class="breadcrumb-item active">My Dashboard</li>
      </ol>

      <form method="post" action="<?php echo base_url()?>region/region_reg">
      ...
      <div class="row row_space">
        <div class="col-sm-4">
          <label class="label_left">Name of Region</label>
        </div>
        <div class="col-sm-4">
          <input type="text" name="regname" id="regname" class="form-control" required placeholder="Type name">
        </div>
      </div>
      ...
      <div class="row row_space">
        <div class="col-sm-4">
          <label class="label_left">Capital of Region</label>
        </div>
        <div class="col-sm-4">
          <input type="text" name="regcapital" id="regcapital" class="form-control" required placeholder="Type Ucode & Confirm or Search & Confirm">
        </div>
        <div class="col-sm-3">
            <button type="button" class="verify_btn verify_regcapital" onclick="verify_regcapital()">View & Confirm</button>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  function verify_regcapital()
  {
    if($('#regcapital').val()!=''&&$('#regcapital').val()!=' ')
    {
      $('#regcapital').attr('readonly',true);
      $('#regcapital').attr('onmousedown','return false');
      $('.verify_regcapital').css('display','none');
      alert("Verified!");
    }
    else
    {
