    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="#"><b>Purchase Account Head Creation</b></a>
        </li>
        <li class="breadcrumb-item active">My Dashboard</li>
      </ol>

      <form method="post" action="<?php echo base_url()?>purchase/purchase_reg">
              <div class="col-sm-4">
...
<div class="col-sm-4">
      ...
      <div class="row parent_space" style="text-align: center;">
        <div class="col-sm-3">
          <label class="label_left">Purchase Account Head Name</label>
        </div>
        <div class="col-sm-5">
          <input type="text" name="purchase" id="purchase" class="form-control" required placeholder="Type">
        </div>
        
       <div class="col-sm-3">
           <button type="button" class="verify_btn verify_purchase" onclick="verify_who('purchase')">Verify & Confirm</button>
        </div>
      ...
      <div class="row parent_space" style="text-align: center;">
        <div class="col-sm-3">
          <label class="label_left">Purchase Account Head U Code</label>
        </div>
        <div class="col-sm-5">
  ...
  window.onload=function()
    ...
    function verify_who(z)
    {
       ...
       else if(z=='purchase')
      {
         ...
         $.ajax ({
            method: 'post',
            url: "purchase/verify_purchase/"+purchase,
            success: function(data)
            {
              if(data)
              {
                  alert('Verified!');
                  $('#purchase').attr('readonly',true);
                  $('.verify_purchase').css('display','none');
                  $('#purchase').attr('onmousedown','return false');
              }
              else
              {
                  alert("Invalid! ");   
