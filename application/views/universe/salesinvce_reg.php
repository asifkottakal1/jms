    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="#"><b>Sales Invoice Register For  JMS </b></a>
        </li>
        <li class="breadcrumb-item active">My Dashboard</li>
      </ol>

      <form method="post" action="<?php echo base_url()?>salesinvce/salesinvce_reg">
              <div class="col-sm-4">
...
<div class="col-sm-4">
      ...
      <div class="row row_space" >
       ...
       <div class="col-sm-3">
           <button type="button" class="verify_btn verify_salesuid" onclick="verify_who('salesuid')">Verify & Confirm</button>
        </div>
...
<div class="row row_space" >
        <div class="col-sm-3">
         ...
         <div class="col-sm-6">
          <select name="sales" id="sales" required class="form-control">
          </select>
        </div>
...
<div class="more" style="visibility: none;" >
 ...
 <div class="row row_space" >
   <div class="col-sm-1">
        ...
        <div class="col-sm-4">
          <input type="text" name="salesitm[]"  class="form-control salesitm" required placeholder="Type Item Code">
        </div>
