    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="#"><b>Cash Recpt Account Head Creation</b></a>
        </li>
        <li class="breadcrumb-item active">My Dashboard</li>
      </ol>

      <form method="post" action="<?php echo base_url()?>cashrcpt/cashrcpt_reg">
        <div class="col-sm-4">
  ...
  window.onload=function()
    {
        ...
        $("#agrphname").autocomplete({
            source:['']
        });
        $('#agrphname').keyup(function(){
            ssid=$('#agrphname').val();
            $.ajax ({
                method: 'post',
