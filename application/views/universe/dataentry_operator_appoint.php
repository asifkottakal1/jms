    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="#"><b>Appoint Data Entry Operator</b></a>
        </li>
        <li class="breadcrumb-item active">My Dashboard</li>
      </ol>

      <form method="post" action="dataentry_operator/dataentry_operator_appoint">
      <div class="row row_space">
      	<div class="col-sm-4">
      		<label class="label_left">Appointed Data Entry Operator</label>
      	</div>
      	<div class="col-sm-5">
