<?php echo form_open('building/registration'); ?>
...
$("#sb").click(function(){
    ...
    html='';
		...
		html+="<div class=\"row form-group\">"
			...
			if(j<0){
				var s= Math.abs(j);
				html+="<input type=\"text\" hidden name=\"floor["+i+"]\" class=\"form-control ocpn\" value='-00"+s+"'>"
			}
			else{
				html+="<input type=\"text\" hidden name=\"floor["+i+"]\" class=\"form-control ocpn\" value='00"+j+"'>"
			}
